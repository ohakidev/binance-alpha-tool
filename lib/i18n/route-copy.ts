...
export const airdropsPageCopy: CopyMap<{
  ...
  th: {
    ...
    telegramCtaPrimary: "คลิกเพื่อรับการแจ้งเตือน Binance Alpha",
    telegramCtaSecondary: "@binance_alphachi บน Telegram",
    tba: "TBA",
    tomorrow: "พรุ่งนี้",
    today: "วันนี้",
    todayShort: "วันนี้",
  ...
  en: {
    ...
    telegramCtaPrimary: "Get Binance Alpha alerts",
    telegramCtaSecondary: "@binance_alphachi on Telegram",
    tba: "TBA",
    tomorrow: "Tomorrow",
    today: "Today",
    todayShort: "Today",
...
export const settingsPageCopy: CopyMap<{
  ...
  th: {
    binanceApiKeyLabel: "Binance API Key",
    binanceApiKeyPlaceholder: "กรอก Binance API Key",
    binanceSecretKeyLabel: "Binance Secret Key",
    binanceSecretKeyPlaceholder: "กรอก Binance Secret Key",
  ...
  en: {
    binanceApiKeyLabel: "Binance API Key",
    binanceApiKeyPlaceholder: "Enter your Binance API Key",
    binanceSecretKeyLabel: "Binance Secret Key",
    binanceSecretKeyPlaceholder: "Enter your Binance Secret Key",
