...
export function IncomeCalendar({
  ...
  // Calculate daily totals - move monthEntries inside useMemo to prevent infinite loop
  const dailyTotals = useMemo(() => {
    const monthEntries = activeUserId
      ? getEntriesByUserAndMonth(activeUserId, month)
      : [];
  ...
  }, [activeUserId, getEntriesByUserAndMonth, month]);
