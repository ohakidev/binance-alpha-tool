 ...
 * Optimized for performance with reduced client-side JavaScript
 */
  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 max-w-7xl">
      <div className="space-y-6">
        ...
        {/* Table skeleton */}
        <div className="relative overflow-hidden bg-gradient-to-br from-[rgba(212,169,72,0.04)] via-[#0a0a0c] to-[rgba(184,134,11,0.03)] rounded-2xl border border-[rgba(212,169,72,0.1)]">
          {/* Table header */}
          ...
          <div className="p-4 space-y-3">
            {[0, 1, 2, 3, 4, 5, 6, 7].map((i) => (
              <div
                key={i}
                className="h-14 rounded-lg bg-[rgba(212,169,72,0.03)] border border-[rgba(212,169,72,0.05)] flex items-center px-4 gap-4 skeleton-pulse"
                style={{
                  opacity: 1 - i * 0.1,
